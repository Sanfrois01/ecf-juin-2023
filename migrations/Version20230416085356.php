 ...
 */
final class Version20230416085356 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE horaire_reservation ADD CONSTRAINT FK_C50111A19A25E124 FOREIGN KEY (horaire_reservation_id) REFERENCES reservation (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
